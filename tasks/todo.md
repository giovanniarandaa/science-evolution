...
- [ ] **RC4** · Mesa: fase de fabricación (material→gesto→pieza) + panel "?" con relación pieza↔material · _M/L_ ⏳ (⚠️ la Mesa no es jugable hasta esta task: la UI aún no sabe fabricar)
